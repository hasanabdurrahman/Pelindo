    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Add Permission <i class="fas fa-refresh refresh-page" onclick="renderView(`{!!route('permission.create')!!}`)"></i> </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="display_name" class="form-input form-control required" name="display_name" placeholder="Display Name">
                                </div>
                            </div>
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    <label for="url">Description</label>
                                    <textarea class="form-control form-input" placeholder="Description" name="description"></textarea>
                                </div>
                            </div>
