<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Add Employee <i class="fas fa-refresh refresh-page" onclick="renderView(`{!!route('employee.add')!!}`)"></i> </h3>
    ...
    <section class="section row">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-vertical" id="add-user" action="javascript:void(0)">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" class="form-input form-control required" name="name" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="code">NIK</label>
                                    <input type="text" id="code" class="form-input form-control required" name="code" placeholder="isikan dengan Nomer Induk Karyawan">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="email">Email </label>
                                    <input type="email" id="email" class="form-input form-control required" name="email" placeholder="ex: test@gmail.com">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address" class="form-input form-control required" name="address" placeholder="ex: Jl.suka maju">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone" class="form-input form-control required" name="phone" placeholder="ex: 0889123...">
                                </div>
                            </div>
