    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>New Request<i class="fas fa-refresh refresh-page" onclick="renderView(`{!!route('request-team.add')!!}`)"></i> </h3>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item spa_route" aria-current="page"><a href="javascript:void(0)" onclick="renderView(`{!!route('transaction.request-team')!!}`)">Request Team</a></li>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select id="karyawan_id" name="karyawan_id"
                                        class="form-input form-control form-select-multiple required" data-placeholder="Pilih Team" style="height: 100%" onchange="checkAvail(this)">
                                        <option></option>
