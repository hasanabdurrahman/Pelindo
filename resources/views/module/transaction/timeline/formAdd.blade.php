            ...
            <table class="table table-centered align-middle table-borderless table-nowrap mb-0 data-table" id="example" style="width: 100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="form-group">
                            <input onchange="changeVal(this)" onkeydown="return false" max="{{$data['project']->enddate}}" min="{{$data['project']->startdate}}" type="date" id="end_date" class="form-input form-control required" name="end_date[]" placeholder="End Date" value="{{date('Y-m-d')}}">
                        </td>
                        ...
                        <td class="form-group text-center" style="margin-left: auto;margin-right:auto">
                            <input class="form-check-input me-0" type="checkbox" id="toggle-work" name="document_check[]" onchange="changeVal(this)">
                            <input type="hidden" name="is_document[]" class="form-input" value="0">
                        </td>
