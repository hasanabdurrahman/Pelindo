    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Additional Timeline <i class="fas fa-refresh refresh-page" onclick="renderView(`{!!route('additional-timeline.edit', base64_encode($data['timeline']->id))!!}`)"></i> </h3>
                ...
                <form class="form form-vertical" id="edit-timeline" action="javascript:void(0)">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="default_adnumber" id="tn_number" class="form-input form-control" value="{{$data['timeline']->ad_number}}" readonly>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                        ...
                        <div id="phase-container">
                            @include('module.transaction.additional_timeline.formEdit')
                        </div>

                        <div class="col-12 d-flex justify-content-end">
                            <button type="submit" id="btn-update" class="btn btn-primary me-1 mb-1">Submit</button>
                            <button type="button" class="btn btn-warning me-1 mb-1" onclick="renderView(`{!!route('master-project.additional-timeline')!!}`)" >Cancel</button>
                        </div>
                    </div>
                </form>
            </div>
