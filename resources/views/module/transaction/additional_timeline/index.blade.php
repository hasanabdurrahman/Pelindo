    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Additional Timeline <i class="fas fa-refresh refresh-page" onclick="renderView(`{!! route('master-project.additional-timeline') !!}`)"></i>
                </h3>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Additional Timeline</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-3" id="container-project-list">
                <div class="card" id="list-project">
                    @if(count($projects) > 0)
                        @include('module.transaction.additional_timeline.projectList')
                    @else
