    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Show Tasklist<i class="fas fa-refresh refresh-page" onclick="renderView(`{!!route('tasklist.show', $tasklist->id)!!}`)"></i> </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select id="project_id" name="project_id" class="form-input form-control required" style="height: 2rem" disabled>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select id="timelineA_id" name="timelineA_id" class="form-input form-control required" style="height: 2rem" disabled>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="progress" class="form-input form-control" name="progress" placeholder=""value="{{$tasklist->progress}}" disabled>
                                </div>
                            </div>
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <textarea type="text" disabled id="description" class="form-input form-control required" name="description" placeholder="" value="{{$tasklist->description}}">{{$tasklist->description}} </textarea>
                                </div>
                            </div>
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    <label for="document_uploaded" class="form-label">Document Uploaded</label>
                                    <div id="document_uploaded">
                                        @php
                                        $documents = !empty($tasklist->document) ? explode(',', $tasklist->document) : [];
                                        @endphp

                                        @if(!empty($documents))
                                            @foreach($documents as $document)
                                                <a href="{{asset('tasklist/document/'.$document)}}" download>{{$document}}</a>
                                            @endforeach
                                        @else
                                            <p>No existing images available.</p>
                                        @endif
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                <button type="button" class="btn btn-warning me-1 mb-1" onclick="renderView(`{!!route('transaction.tasklist')!!}`)" >Back</button>
                            </div>
                        </div>
                    </div>
                </form>
