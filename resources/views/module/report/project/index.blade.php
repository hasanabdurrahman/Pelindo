<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Project Report <i class="fas fa-refresh refresh-page" onclick="renderView(`{!!route('report.project-report')!!}`)"></i> </h3>
    ...
    <section class="section row">
        <div class="card">
            <div class="card-body">
                <form class="form form-vertical" id="project-report" action="javascript:void(0)">
                    @csrf
                    <div class="row align-items-center justify-content-between">
                        <div class="col-12">
                            <h5>Periode Project</h5>
                        </div>
            ...
            <div class="card-body">
                <div class="table-responsive table-card px-3">
                    <table class="table table-centered align-middle table-nowrap mb-0 data-table" id="example" style="width: 100%">
                        <thead class="text-muted table-light" id="thead">
                            <tr>
                                {{-- <th></th> --}}
                                <th scope="col">#</th>
    ...
    <script type="text/javascript" src="{{ asset('js/module/report/project-report/project-report.js') }}"></script>
</div>