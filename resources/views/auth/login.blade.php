                        ...
                        <div class="card mb-0" style="opacity: 0.9;">
                            <div class="card-body p-3 p-sm-5 m-lg-2">
                                <div class="text-center">
                                    <img width="25%" src="{{ asset('assets/images/logo/logo-edi.png') }}" alt="Logo EDII" style="border-radius: 1rem">
                                    <h5 class="text-primary fs-22 mt-3">Welcome Back !</h5>
                                    <p class="text-muted">Sign in to continue to EDII Project Management System.</p>
                                </div>
                                <div class="p-2 mt-5">
